...
void Player::setGuildId(int id) {
    guildId = id;
}

int Player::getGuildId() const {
    return guildId;
}


void Player::setGuildName(const string& name) {
    guildName = name;
}

string Player::getGuildName() const {
    return guildName;
}